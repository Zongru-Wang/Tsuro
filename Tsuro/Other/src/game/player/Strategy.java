...
public interface Strategy {
    String ILLEGAL_STRATEGY_NAME = "Illegal Strategy name must be one of: \"dumb\" or \"second\"";
    /**
     ...
     */
    InitialPlacement generateInitialPlacement(Board board, List<Tile> availableTiles, Token token, RuleChecker checker);
     ...
     */
    IntermediatePlacement generateIntermediatePlacement(Board board, List<Tile> availableTiles, Token token, RuleChecker checker);
