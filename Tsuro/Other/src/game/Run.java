...
/**
 * Runner for run the client and server. Creates a server from the input,
 * And get a list of clients from the input. If the valid clients has correct number,
 * Run the game. 
 */
public class Run {
    ...
    public static void main(String[] args) {
        try {
            ...
            Server server = new Server(InetAddress.getLocalHost(), 8000, logger);
